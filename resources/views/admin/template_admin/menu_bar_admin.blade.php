...
<body>
    ...
    <nav class="flex items-center">
        ...
        <ul  class="list-1" id=" js-menu">
            ...
            <li class="list-1 li style1"><a href="/dashboard">แดชบอร์ด</a></li>
            <li class="list-1 li style1"><a href="/types">ประเภท</a></li>
            <li class="list-1 li style1"><a href="/building">อาคารเรียน</a></li>
            <li class="list-1 li style1"><a href="/cargivers">ผู้ดูแล</a></li>
            ...
            <li class="list-1 li style1 count-number-con">
