            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <!-- Qr---------------------------------------------------------------------------------------- -->
                            <td>
                                <button type="submit" onclick="printQRCode(<?php echo $i ?>, <?php echo htmlspecialchars(json_encode($row)) ?>)">

                                    <input type="hidden" value="<?php echo $row->da_id ?>" id="testqr" name="testqr">
                                    <input type="hidden" value="<?php echo $row->da_name ?>" id="passname" name="passname">
                                    <input type="hidden" value="<?php echo $row->caregiver_name ?>" id="passcare" name="passcare">
                                    <input type="hidden" value="<?php echo $row->da_price ?>" id="passprice" name="passprice">
                            ...
                            <!-- จำหน่าย -->
                            <td>
                                <div class="row" id="list-sell"></div>
                                <button class="sell-button" data-itemname3="<?php echo $row->da_id ?>">
    ...
    <script>
        function confirmDelrow(id, caename, status) {
            ...
            $('.btn-confirm').click(function() {
                $.post('/deletetableneo/' + id + '/' + caename + '/' + status, {
