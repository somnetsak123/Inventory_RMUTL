                        ...
                        <div class="test_index">
                            ...
                            ?>
                                <div class="test_margin">
                                    <a href="\show_user?da_id=<?php echo $f['da_id'] ?>">
            ...
            <script type="text/javascript">
                ...
                $(function() {
                    $("#btnSearch").click(function() {
                        ...
                        var url = "/?when=" + encodeURIComponent(itemname) + "&type=search";
