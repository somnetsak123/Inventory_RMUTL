        ...
        <h4>
            ...
            <center>
                <div class="<?php echo $data ?>">
                    <a href="/?when=<?php echo $row->cargiver_id ?>&type=cargiver" class="align_caregiver bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="p-4 leading-normal text-center">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{$row->status}} {{$row->caregiver_name}}</h5>
                        </div>
                    </a>
