    ...
    <center>
        <table>
            <tr>
                    ...
                    <div class="items-center text-center  row col-md-12">
                        <form class="flex items-center form-inline" name="searchform" id="searchform">
                            ...
                            <div class="relative ">
                                ...
                                <input type="text" id="itemname" name="itemname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required autocomplete="off">
                            </div>
                            <button id="btnSearch" type="button" class="form-control btn btn-primary p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:focus:ring-blue-800 hover_transition">
                ...
                <th> <button onclick="scanQRCode()" data-modal-toggle="QR_codeT" id="QR_code" type="button" class=" flex form-control btn btn-primary p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:focus:ring-blue-800 hover_transition">
